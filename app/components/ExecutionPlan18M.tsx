...
const marketData: { [key: string]: string } = {
  ...
  "2025-12": "• Conduct structured interviews with purchasers, drivers, fleet owners, and depot managers across the 3-5 potential pods.\n• Complete and transcribe the initial set of ~28 stakeholder interviews.\n• Continue building the Pod Heat Map with detailed intelligence on each candidate area.",

  "2026-01": "• Analyze all interview data to identify the most critical, addressable pain points.\n• Synthesize findings into a preliminary \"Validated Pain Point Matrix\" report.\n• Conduct comparative analysis of the 3-5 candidate pods based on interview data.\n• Create a priority list of the highest-value contacts to meet in each pod.",

  "2026-02": "• Analyze the researcher's comprehensive report and finalize selection of the primary launch pod.\n• Attend 10-15 introductory meetings scheduled by your researcher within the selected launch pod.\n• Listen, learn, and establish personal credibility with potential partners.\n• Validate the pain points identified from the remote interviews in face-to-face conversations.\n• Create a shortlist of \"Friendlies\"—individuals open to further conversation in the launch pod.",
...
const gtmData: { [key: string]: string } = {
  ...
  "2025-12": "• Continue building intelligence on all 3-5 candidate pods.\n• Identify key decision-makers and influential suppliers across all candidate areas.\n• Map depots and potential B2B clients in each candidate pod.\n• Create preliminary Pod Directories for comparison.",

  "2026-01": "• Refine the Pod Directories based on interview learnings from December.\n• Begin scheduling meetings across the candidate pods for the February trip.\n• Prioritize highest-value contacts in each area to inform final pod selection.\n• Establish a goal of securing 10-15 confirmed meetings with key decision-makers.",

  "2026-02": "• Attend pre-scheduled meetings with potential partners across candidate pods.\n• Use these meetings to finalize the launch pod selection based on relationship potential and market readiness.\n• Once pod is selected, focus entirely on building rapport within that area.\n• Build the foundation of trust, as business is personal in Ghana.\n• Create a shortlist of \"warm leads\" in the selected launch pod who are receptive to follow-up.",
  ...
  "2026-08": "• Meet with the interested drivers and depot owners your team has lined up.\n• Personally onboard your first 5-10 truck drivers and 2-3 depots by end of month.\n• Offer a heavily subsidized deal (e.g., 12 months free access) to secure initial suppliers.\n• Ensure your initial, vetted supplier network is live, trained, and ready for September launch.",
...
const technicalData: { [key: string]: string } = {
  ...
  "2026-06": "• Build the V1 Admin Panel (\"God Mode\") for manual order management and user support.\n• Complete end-to-end testing of the full transaction cycle in the Android app.\n• Build the \"add/manage drivers\" feature for Fleet Owners on the web app.\n• Platform and mobile app must be operational by end of month for testing and pod mapping.\n• Begin using the system to map and validate locations within the selected launch pod.",
...
const hiringData: { [key: string]: string } = {
  ...
  "2026-08": "• Interview your final 2-3 candidates in person during your on-the-ground trip.\n• Make a hiring decision and extend an offer to your chosen Operations Manager candidate.\n• Execute the employment agreement with your new Operations Manager.\n• Onboard and train the Operations Manager on the launch playbook, Admin Panel, and all supplier relationship protocols by end of month.\n• Have the Operations Manager shadow you intensively during supplier onboarding and beta test to learn hands-on operations management.\n• Ensure Operations Manager is fully prepared for September launch.",
